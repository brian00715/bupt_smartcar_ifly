...
key_points = [
    [3.411233, -0.000090, 0.000, 1.0,1.4],  # 1
    [4.042557, -1.565172, 3.082496, 0.95,1.4],  # 2
    [2.936867, -1.032038, -3.14, 1.2,1.4],  # 3
    [1.795490, -1.044512, -2.983582, 1.1,2.8],  # 4
    # [4.646070, -1.056370, -2.934374,1.3],  # 5
    [2.218460, -2.536215, -1.542630, 1.0, 2.7],  # 6
    # [0.861139, -3.080960, -1.812663, 1.0,2.3],  # 7
    # [4.646070, -1.056370, -2.934374,1.3],  # 8
    [1.504895, -4.168083, 0.000, 1.2,1.5],  # 9
    [2.956114, -4.201780, 0.000, 1.1,2.9],  # 10
    [4.295692, -3.125136, 0.000, 1.2,3.2],  # 11
    [5.327578, -4.342858, -2.392219, 1.7,3.8],  # 12
    [0.754753, -5.769012, 2.688439, 0.7,1.8],  # 13 teb中为防止终点震荡单独附加一个限速点
    # [0.836030, -5.705181, 2.962307, 0, 0],  # 16  # 14 终点
]
