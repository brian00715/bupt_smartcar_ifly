...
key_points = [
    ...
    [2.000, -0.000090, 0.000, 1.77, 1.50,55],  # 0.5
    [3.7, -0.000090, 0.000, 0.76, 1.5,52],  # 1
    [4.702972, -1.080354, 3.082496, 1.35, 1.5,55],  # 2
    [2.936867, -1.032038, -3.14, 1.47, 1.5,55],  # 3
    [1.995490, -1.044512, -2.983582, 0.8, 1.5,55],  # 4
    ...
    [1.665421, -4.329203, 0.063971, 1.4, 1.5,55],  # 9
    # [2.956114, -4.201780, 0.000, 1.1, 1.5],  # 10
    [4.295692, -3.125136, 0.000, 1.25, 1.5,55],  # 11
    [5.027173, -3.123793, 0.000, 1.1, 1.5,55],  # 12
    [5.194778, -4.593526, -2.392219, 2.0, 2.0,55],  # 13
    [2.902147, -5.983389, 0, 1.96, 2,55],  # 14
    [1.717385, -5.971060, 0, 1.6, 2,55],  # 15
    [0.836030, -5.705181, 2.962307, 0.00, 1.0,55],  # 16
